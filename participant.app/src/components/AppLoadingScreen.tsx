...
export function AppLoadingScreen({ role = "driver" }: AppLoadingScreenProps) {
  ...
  const loadingPrimary = appConfig.branding.loading_primary_color || "#58C7F2";
  const loadingBase = appConfig.branding.loading_base_color || "#091028";
    ...
    >
      <div className="flex w-full max-w-sm flex-col items-center gap-6 text-center">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-slate-200">Operasyon verileri kontrol ediliyor...</p>
        </div>
