...
class Project(Base):
    ...
    system_code = Column(String(24), nullable=True, index=True)
...
class Upload(Base):
    ...
    pricing_scan_enabled = Column(Boolean, nullable=False, default=False)
...
class Transfer(Base):
    ...
    participant_kayit_id = Column(Integer, nullable=True, index=True)
    ...
    sub_reservation_no = Column(String(96), nullable=True, index=True)
    supplier_company_id = Column(Integer, ForeignKey("supplier_companies.id"), nullable=True, index=True)
    vehicle_revision_status = Column(String(16), nullable=True, index=True)
    vehicle_revision_updated_at = Column(DateTime(timezone=True), nullable=True, index=True)
    vehicle_revision_decision_at = Column(DateTime(timezone=True), nullable=True, index=True)
    vehicle_revision_decision_by_user_id = Column(Integer, ForeignKey("users.id"), nullable=True, index=True)
    vehicle_revision_decision_note = Column(Text, nullable=True)
    ...
    matrah = Column(Float, nullable=True)
    kdv = Column(Float, nullable=True)
...
class User(Base):
    ...
    user_code = Column(String(6), nullable=True, unique=True, index=True)
    email = Column(String(128), nullable=True, index=True)
    tc_kimlik_no = Column(String(16), nullable=True, index=True)
    passport_no = Column(String(24), nullable=True, index=True)
...
class PasswordResetRequest(Base):
    ...
    channel = Column(String(16), nullable=False, index=True)  # email | sms
    destination = Column(String(128), nullable=False, index=True)
    reset_code = Column(String(12), nullable=False)
...
class SupplierCompany(Base):
    ...
    tenant_id = Column(Integer, ForeignKey("tenants.id"), nullable=False, index=True)
    name = Column(String(128), nullable=False, index=True)
    company_type = Column(String(16), nullable=False, default="agency", index=True)  # agency | vehicle
    ui_theme_family = Column(String(32), nullable=False, default="zumrut_operasyon", index=True)
    is_active = Column(Boolean, nullable=False, default=True)
    created_at = Column(DateTime(timezone=True), server_default=func.now(), nullable=False)
...
class OperationChannel(Base):
    __tablename__ = 'operation_channels'
...
class OperationChannelMessage(Base):
    __tablename__ = 'operation_channel_messages'

    id = Column(Integer, primary_key=True, index=True)
    channel_id = Column(Integer, ForeignKey('operation_channels.id'), nullable=False, index=True)
    tenant_id = Column(Integer, ForeignKey('tenants.id'), nullable=False, index=True)
    project_id = Column(Integer, ForeignKey('projects.id'), nullable=False, index=True)
